...
# Only define the class if open3d is available
if HAS_OPEN3D:
    class FloorPlan3DGenerator:
        ...
        def create_wall_mesh(self, wall: WallSegment, img_shape: Tuple[int, int]):
            """
        ...
        def create_room_floor(self, room: Room, img_shape: Tuple[int, int]):
            """
        ...
        def create_floor_plane(self, img_shape: Tuple[int, int]):
            """
        ...
        def save(self, mesh, filepath: str) -> bool:
            """
            Save mesh to file.
    ...
    # Placeholder class when Open3D is not available
    class FloorPlan3DGenerator:
